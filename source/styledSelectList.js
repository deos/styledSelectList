/**
 ...
 shrinkListWidth          If this option is greater then 0, the list width gets shrinked by the amounth of px, e.g. for placing it under rounded corners (default: 0)
...
var styledSelectList = new Class({
	...
	options: {
		...
		*/
		...
		'animationOptions': { duration: 'short' },
